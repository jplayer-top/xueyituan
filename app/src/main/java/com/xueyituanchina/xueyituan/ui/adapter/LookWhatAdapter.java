...
public class LookWhatAdapter extends BaseQuickAdapter<LookWhatBean, BaseViewHolder> {
    public LookWhatAdapter(List<LookWhatBean> o) {
        super(R.layout.adapter_shop_fav, o);
    }

    @Override
    protected void convert(BaseViewHolder helper, LookWhatBean item) {
