 ...
 * com.ilanchuang.shopmodule.shop.activity
...
public class LocalSelMapActivity extends CommonToolBarActivity implements
        ...
        if (this.mLocationChangedListener != null) {
            this.mHandler.post(() -> {
                if (locationInfo != null) {
                    ...
                    Toast.makeText(mActivity, getString(io.rong.imkit.R.string.rc_location_fail), Toast.LENGTH_SHORT)
                            .show();
                }
    ...
    public void initAddView(FrameLayout rootView) {
        ...
        this.mAMapView = this.findViewById(io.rong.imkit.R.id.rc_ext_amap);
        this.mHandler = new Handler();
        this.mLocationTip = this.findViewById(io.rong.imkit.R.id.rc_ext_location_marker);
        this.findViewById(io.rong.imkit.R.id.rc_ext_my_location).setOnClickListener(v -> {
    ...
    public void toolRightBtn(View v) {
        ...
        EventBus.getDefault().post(new LocalSelEvent(curLnglat, curAddr));
        finish();
    }
    ...
    private void addLocatedMarker(LatLng latLng, String poi) {
        ...
        this.mLocationTip.setText(String.format("%s", new Object[]{poi}));
    }
    ...
    private void animMarker() {
        ...
        this.animator.addUpdateListener(animation -> {
            ...
            mMarker.setPositionByPixels(mAMapView.getWidth() / 2, Math.round(value.floatValue()));
        });
